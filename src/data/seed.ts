  ...
  days: [
    {
      ...
      activities: [
        act(
          ...
          50,
          'BART: SFO → Lake Merritt (~40 min, ~$10/person), then walk 10 min to 444 Embarcadero West. Uber alternative runs closer to $12/person if you want to skip the transfer.',
        ),
        act(
          'd1a2',
          '23:45',
          ...
          50,
          'Grab food near the hotel or order delivery. Drop bags, settle in — early night. ~$10/person.',
        ),
      ],
    },
    {
      ...
      activities: [
        ...
        act(
          ...
          150,
          'Walk 10 min north along Embarcadero. 500+ interactive exhibits: science, art, AI. Plan 3–4 hours. Thursdays have an 18+ After Dark session 6–10 PM. ~$30/person entry, opens 10 AM.',
        ),
        act(
          'd2a3',
          '14:30',
        ...
        act(
          ...
          80,
          'City Lights Bookstore, Coit Tower views, pizza for dinner. Then Chinatown — Dragon Gate, markets, boba. Dinner ~$12/person. BART home to Lake Merritt ~$4/person (~20 min).',
        ),
      ],
    },
    {
      ...
      activities: [
        ...
        act(
          ...
          80,
          'El Farolito or La Taqueria on 24th St (~$10/person). Walk to Castro — Rainbow Honor Walk, Harvey Milk shop, fun stores. Bi-Rite Creamery on the way back (~$6/person).',
        ),
        act(
          'd3a4',
          '17:00',
    ...
    },
    {
      ...
      activities: [
        ...
        act(
          ...
          225,
          'Hit Superman Ultimate Flight, Joker, and Batman: The Ride first — lines double by noon. Animal exhibits (dolphins, tigers) between rides. List price is $60–80/person, but buying online ahead of time (plus the 5+ group discount) brings it closer to ~$45/person — budgeted at the discounted rate.',
        ),
        act(
          'd5a3',
          '12:30',
          ...
          75,
          'Roar coaster, V2: Vertical Velocity, Boomerang. Check the stunt show + animal presentation schedule — free inside. Water park section for hot days. Park food ~$15/person — bring snacks to save.',
        ),
        act(
          'd5a4',
          '18:00',
    ...
    },
    {
      ...
      activities: [
        act(
          ...
          45,
          '~35 min from Oakland, no direct transit. Pick up food and 2L+ water each before leaving — park opens at sunrise. Uber ~$35 total + $10/car day-use fee, split 5 ways.',
        ),
        act(
          'd6a2',
          '08:30',
        ...
        act(
          ...
          75,
          "Uber back to Jack London Square. Everett & Jones BBQ nearby is Oakland-legendary and very filling — you've earned it. ~$15/person. Alternative if low energy: skip the hike for a Lake Merritt walk + Temescal neighbourhood instead.",
        ),
      ],
    },
    {
      ...
      activities: [
        ...
        act(
          ...
          75,
          "Walk back to the hotel area. Dinner on the waterfront, stroll the marina, watch the SF skyline and Bay Bridge light up right outside your door. Dinner ~$15/person.",
        ),
        act(
          'd7a5',
          '20:00',
